...
if __name__ == "__main__":
    ...
    parser.add_argument("mode_file", help="Train/Test text file.", type=str)
    args = parser.parse_args()
    fd = open(args.mode_file, 'r')
    lines = fd.readlines()
    xml_files = []
    for line in lines:
        xml_files.append(os.path.join(args.xml_dir, line.strip()+'.xml'))
